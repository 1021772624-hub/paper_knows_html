...
# This file is too large to create directly, so we use Python
...
# Write the file
with open('material-prediction.html', 'w', encoding='utf-8') as f:
    f.write(html_content)

print("Created material-prediction.html with header")
